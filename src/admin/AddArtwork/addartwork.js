  ...
  return (
    ...
    <div className="Addartwork_grid">
      ...
      <div className="Addartwork_aside">
        ...
        <p className="Addartwork_stats">Total No. Exhibits</p> <p className="number">46</p>
        <p className="Addartwork_stats">Total No. Questions</p>{" "}
        <p className="Addartwork_number">13</p>
        <p className="Addartwork_stats">Answered Questions</p> <p className="number">10</p>
      ...
      <div className="Addartwork_main">
        ...
        <div className="form2">
          <form action="/action_page.php" className="Addartwork_form">
            ...
            <input type="text" name="title" className="Addartwork_maininput-1" />
            <label className="Addartwork_mainlabel">Artist's Name</label>
            <input type="text" name="artist" className="Addartwork_maininput-2" />
            <br />
