    ...
    return (
        <div className="container">
            <div className='header'>
                <div className="logo">
                    <span ><img src={design} alt="Logo" className="muspic" /> <h1 >MUSEUM ADM<span className="gold">I</span>N</h1></span>
                </div>
                <div className="bar">
            ...
            <div className='nav'>
                <button className="navimen"><a href=""><h2 className="menu">NAVIGATION MENU</h2></a></button>
                <button className="dash"><a href=""><h3>Dashboard</h3></a></button>
            ...
            <div className="mobilefoot">
                ...
                <button className="footmess"><img src={footmess} alt="messages" /></button>
                <button className="footexhi"><img src={footexhi} alt="exhibits" /></button>
