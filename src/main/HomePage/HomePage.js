...
function HomePage() {
    return (
      ...
      @import url('https://fonts.googleapis.com/css2?family=Hind:wght@400;700&family=Open+Sans&display=swap');
        </style>
       
        <div className="hero">
          <div id="bar">
        <div id="search">Search<img src={vector} id="magnifier"  alt="head"/></div>
        
        <div className="welcomebody">

        <h1>Welcome to the Museum Experience!</h1>
        <p class="explore">Explore the exhibition gallery, videos, articles, and more</p>
