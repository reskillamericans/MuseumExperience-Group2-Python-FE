    ...
    <div className="c1">
        <div className="container">
          ...
          <div className="content">
            <div className="box">
              <div className="icon">
              <img src={vector1} id="web-icon" alt="icon" width="57px" height="60px"/>
              <img src={group10} id="mobile-icon" alt="icon" width="57px" height="60px"/>
              </div>
            ...
            <div className="color-pic">
              <img src={rectangle81} id="color-pic" alt="icon" width="147px" height="150px"/>
