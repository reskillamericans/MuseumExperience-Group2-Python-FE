...
function SearchPage() {
    ...
    <div className="box-mag"><img src ={image10} alt="box-mag" /></div>
    </div>
    ...
    <div className="container1">
        <div className="artwork"><b>Artwork</b></div>
        <img src={image41} alt="art1"></img> 
        
    <div className="description1">
       <ul class= "list"><b>The Absinthe Drinker</b>
    ...
    <div className="description2">
       <ul class= "list"><b>The Bellelli Family</b>
        <li>Edgar Degas (French, Paris 1834-1914 Paris)</li>
    ...
    <div className="description3">
       <ul class= "list"><b>Dancer with a Fan</b>
        <li>Edgar Degas (French, Paris 1834-1914 Paris)</li>
        <li>Date: 1879</li>
        <li>Medium: Oil on Canvas</li>
        </ul>
    ...
    <div className="description4">
       <ul class= "list"><b>A Woman Seated beside a Vase of Flowers (Madame Paul Valpincon)</b>
        <li>Edgar Degas (French, Paris 1834-1914 Paris)</li>
        <li>Date: 1865</li>
        <li>Medium: Oil on Canvas</li>
        </ul>
